...
const Banner = () => {
            ...
            <div className="mb-20 text-center">
              <div className="presale-cards-container">
                <div className="info-card">
                  ...
                  <div className="flex justify-between items-center bg-[rgb(255,163,54)] p-4">
  <h5 className="w-auto ff-outfit fw-600 text-stroke-2 text-white text-uppercase">
    TRUMPIDENTAL TOWER
  </h5>
  <button onClick={handleDownload}>
    ...
    />
                    ...
                    <h3 className="py-4 titillium-web-bold  text-black font-bold">
